-- M1: View del update más reciente por hospital
...
FROM update_hospital uh 
  ...
  -- M2: View del update completo más reciente por hospital
...
FROM update_hospital uh 
  ...
  -- M3: View de los problemas por hospital 
...
-- M4: ¿Qué hospitales no tienen un update completo?
...
-- M5: ¿Qué hospitales tienen un update completo este wave?
...
-- M6: ¿Cuántos y cuáles problemas se presentaron en el último wave?
